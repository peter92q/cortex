  ...
  return (
    <div className="my-20 mx-10 flex sm:flex-row flex-col-reverse justify-between items-center">
        ...
        <div className='flex flex-col mb-10'>
            ...
            <div className="w-[450px] h-[140px] bg-gray-gradient rounded-lg m-2 hover:bg-dimWhite duration-500">
                <h1 className='text-gradient2 font-poppins text-[22px] mt-5 w-[400px] font-bold ml-5 tracking-widest'>Premium membership</h1>
                <p className='text-gradient2 mx-4'>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium<br/> totam rem aperiam, eaque ipsa quae ab illo.</p>
                <div className='flex items-end justify-end relative -top-[70px] mr-5'>
            ...
            <div className="w-[450px] h-[140px] bg-gray-gradient rounded-lg m-2 hover:bg-dimWhite duration-500">
                <h1 className='text-gradient2 font-poppins text-[22px] mt-5 w-[400px] font-bold ml-5 tracking-widest'>Exclusive offers</h1>
                <p className='text-gradient2 mx-4'>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium<br/> totam rem aperiam, eaque ipsa quae ab illo.</p>
                <div className='flex items-end justify-end relative -top-[70px] mr-5'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-10 h-10 text-teal-500">
